...
<ul><li>- 🌳 1 tree absorbs roughly 21 kg of CO₂ per year. 
  → 1 વૃક્ષ દર વર્ષે આશરે 21 કિલોગ્રામ CO₂ શોષી લે છે.</li>
<li>- 🚗 Driving 1 km in an average petrol car emits about 0.25 kg of CO₂. 
  → સરેરાશ પેટ્રોલ કાર 1 કિ.મી. દોડે ત્યારે આશરે 0.25 કિલોગ્રામ CO₂ ઉત્સર્જિત કરે છે.</li>
<li>- 💡 Using 1 kWh of electricity produces around 0.92 kg of CO₂.  
  → 1 કિલોવોટ કલાક વીજળીના ઉપયોગથી આશરે 0.92 કિલોગ્રામ CO₂ ઉત્પન્ન થાય છે.</li></ul><br>
